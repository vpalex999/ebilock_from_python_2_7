...
class ServerEHAFactory(Factory):
    ...
    def start_check(self):
        allure.attach("In start_check", "status connect: {}".format(self.status_connect))
    ...
    def check_connect(self):
        with pytest.allure.step("Third step"):
...
class EhaTestCaseClient1(TestCase):
    ...
    def test_trial_connect_for_client_port1(self):
        ...
        with pytest.allure.step("Second step"):
            allure.attach("Activate callback", "Call from factory.start_check()")
